...
module Linuxcnc
  module Commands
    ...
    # With get, any parameter is ignored, and the current enable state is returned. With set and a valid password
    # matching linuxcncrsh’s --enablepw (EMCTOO if not specified),
